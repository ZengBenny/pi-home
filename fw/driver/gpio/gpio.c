...
//        { 4     ,  GPIOF_DIR_IN     , "Reserved"    },
//        { 5     ,  GPIOF_DIR_IN     , "Reserved"    },
//        { 6     ,  GPIOF_DIR_IN     , "Reserved"    },
//        { 12    ,  GPIOF_DIR_IN     , "Reserved"    },
//        { 13    ,  GPIOF_DIR_IN     , "Reserved"    },
        { 16    ,  GPIOF_DIR_IN     , "temp"        },
//        { 17    ,  GPIOF_DIR_IN     , "Reserved"    },
//        { 18    ,  GPIOF_DIR_IN     , "Reserved"    },
//        { 19    ,  GPIOF_DIR_IN     , "Reserved"    },
        { 20    ,  GPIOF_DIR_OUT    , "led_1"       },
        { 21    ,  GPIOF_DIR_OUT    , "led_2"       },
//        { 22    ,  GPIOF_DIR_IN     , "Reserved"    },
//        { 23    ,  GPIOF_DIR_IN     , "Reserved"    },
//        { 24    ,  GPIOF_DIR_IN     , "Reserved"    },
//        { 25    ,  GPIOF_DIR_IN     , "Reserved"    },
//        { 26    ,  GPIOF_DIR_IN     , "Reserved"    },
//        { 27    ,  GPIOF_DIR_IN     , "Reserved"    },
};
//========================================================================
